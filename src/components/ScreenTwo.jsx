...
export const ScreenTwo = ({ onClick }) => {
	...
	return (
		<div className="screen-two h-full w-full bg-gradient-to-b from-[#272626] to-[#0f0f0f] flex flex-col px-4 py-3 ">
			<div className="h-full w-full screen-two-target-container ">
				<div className="flex justify-between items-center  pt-1 pb-6">
					<div className="text-sm font-medium text-gray-300">{"11:11"}</div>
				...
				{/* Main content */}
				<div className="herocontent w-full flex flex-col items-start relative z-20 ">
				...
				<div
					className="motocycle absolute left-0 w-[35rem] h-[35rem] bottom-0 z-20  "
					style={{
				...
				<button
					onClick={onClick}
					className="btn absolute z-20 bottom-2 left-1/2 -translate-x-1/2 bg-[#FF6F00] text-black border-none py-2 px-4 rounded-xl text-lg font-bold flex items-center justify-center mt-auto mb-8 self-center cursor-pointer"
				>
					Get Started
